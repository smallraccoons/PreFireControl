<template>
    <div class="app-container">
        ...
        stripe
            ...
            <el-table-column prop="userName" label="户主名称"/>
            <el-table-column prop="userName" label="姓名"/>
            <el-table-column prop="phoneNumber" label="手机号"/>
            <!-- <el-table-column prop="sex" label="性别"/> -->
            <!-- <el-table-column prop="sex" label="年龄"/> -->
            <el-table-column prop="homeId" label="家庭编号"/>
            <el-table-column prop="address" label="地址"/>           
            <el-table-column label="处理状态" prop="param.statusString"/>
            <el-table-column label="事件类型" prop="param.authStatusString"/>
            <el-table-column prop="createTime" label="创建时间"/>

            <el-table-column label="处理进程" width="200" align="center">
                <template slot-scope="scope">
                    <router-link :to="'/user/userInfo/show/'+scope.row.id">
                        <el-button type="primary" size="mini">查看</el-button>
                    </router-link>
                    <router-link :to="'/user/userInfo/'+scope.row.id">
...
export default {
    ...
    fetchData(page = 1) {
        ...
        // 异步获取远程数据（ajax）
        this.page = page
            userInfoApi.getUserInfoList(this.page, this.limit, this.searchObj).then(
                response => {
